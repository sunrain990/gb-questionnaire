...
function addQiniuJSOnce(){
    ...
    var $qiniu3 = $('<script type="text/javascript" src="../../_jslibs/qnupload/ui.js"></script>');
...
gem.initApp = function(app) {
    ...
    app.run(function($rootScope, $location, $anchorScroll) {
        ...
        //var qnbox = $('#qnContainer');
        //if (!qnbox[0]) {
        //    qnbox = $('<div id="qnContainer"></div>');
        //    $('body').prepend(qnbox);
        //};
        //var choosefiles = $("<span id='choosefiles'><button class='btn btn-warning' style='background:orange'>上传文件</button></span>");
        ...
        function initQN(type, event, resfn,qnbox,container,choosebtn,choosefiles){
            console.log('initing!');
            var uploader1 = Qiniu.uploader({
                runtimes: 'html5,flash,html4',
                browse_button: choosebtn,
                //browse_button: 'choosefilesG',
                container: container,
                ...
                init: {
                    //'Init':function(up,info){
                    //    console.log('init',up,info);
                    //    console.log(choosebtn+"66666");
                    //    console.log(choosefiles,'this is choosefiles');
                    //
                    //    console.log($('#'+choosebtn+" button"),'this is choosebtn');
                    //    //setTimeout(function(){
                    //        $('#'+choosebtn+" button").click();
                    //    //},5000);
                    //
        ...
        $rootScope.uploadFile = function(type, event, resfn) {
                ...
                if (!qnbox[0]) {
                    qnbox = $('<div id="'+container+'"></div>');
                    $('body').prepend(qnbox);
                    choosefiles.appendTo(qnbox);
                };

                initQN(type, event, resfn,qnbox,container,choosebtn,choosefiles);
            ...
            //<div id="upContainer" onmousemove="" class="choose banner1_btn">
            //    <span id="pickfiles">
            //    <button class="btn btn-warning" style="background:orange">上传文件</button>
            //    </span>
            //    <div id="fsUploadProgress"></div>
            //    </div>
            //

            //var qnbox = $('#qnContainer1');
            //if (!qnbox[0]) {
            //    qnbox = $('<div id="qnContainer1"></div>');
            //    $('body').prepend(qnbox);
            //};
            //var choosefiles = $("<span id='choosefiles1'><button class='btn btn-warning' style='background:orange'>上传文件</button></span>");
            //choosefiles.appendTo(qnbox);
            ...
            //formtmp.attr('action', gem.filesite + '/common/uploadfileV2');
